...
-- Run this to update the functions with corrected logic
-- ==========================================
...
-- Function 1: Get League Wins Leaderboard (FIXED)
...
DO $$
BEGIN
  RAISE NOTICE '✅ Leaderboard functions updated!';
  RAISE NOTICE 'Testing functions...';
END $$;

-- Show results
SELECT 'LEAGUE WINS' as test, COUNT(*) as count FROM get_league_wins_leaderboard();
SELECT 'TOTAL POINTS' as test, COUNT(*) as count FROM get_total_points_leaderboard();
SELECT 'RECENT WINNERS' as test, COUNT(*) as count FROM get_recent_winners();

-- Show sample data
SELECT '=== LEAGUE WINS LEADERBOARD ===' as section;
SELECT * FROM get_league_wins_leaderboard() LIMIT 5;

SELECT '=== TOTAL POINTS LEADERBOARD ===' as section;
SELECT * FROM get_total_points_leaderboard() LIMIT 5;

SELECT '=== RECENT WINNERS ===' as section;
SELECT * FROM get_recent_winners() LIMIT 5;
