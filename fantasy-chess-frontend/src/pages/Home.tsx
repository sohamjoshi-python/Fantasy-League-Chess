...
const Home: React.FC = () => {
  return (
    <div className="w-full min-h-screen bg-primary flex flex-col items-center font-sans pt-20">
      ...
      {/* About Section */}
      <section className="w-full py-12 flex justify-center bg-primary mt-12">
        <div className="max-w-2xl w-full bg-white rounded-2xl shadow p-8 flex flex-col items-center border border-gold">
          <h2 className="text-2xl font-bold mb-2 text-primary">About Pawn Royale</h2>
      ...
      <section className="w-full py-12 bg-primary flex justify-center">
        <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center border border-gold">
            ...
            <h3 className="font-semibold text-lg mb-2 text-primary">Draft Your Team</h3>
            <p className="text-slate text-center text-sm">Take turns picking titled chess players in a fair snake draft. Build your dream team!</p>
          </div>
          <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center border border-gold">
            <Trophy className="w-10 h-10 mb-3 text-gold" />
            <h3 className="font-semibold text-lg mb-2 text-primary">Set Weekly Lineups</h3>
            <p className="text-slate text-center text-sm">Choose 5 players each week. Earn points based on their real Titled Tuesday performance.</p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-12 flex justify-center bg-primary">
        <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow p-6 flex items-center gap-4 border border-gold">
            ...
            <div>
              <h4 className="font-semibold text-base mb-1 text-primary">Secure & Transparent</h4>
              <p className="text-slate text-sm">All results and transactions are visible and verifiable.</p>
            </div>
          </div>
          <div className="bg-white rounded-xl shadow p-6 flex items-center gap-4 border border-gold">
            <Calendar className="w-8 h-8 text-gold" />
            <div>
              <h4 className="font-semibold text-base mb-1 text-primary">Monthly Leagues</h4>
              <p className="text-slate text-sm">New leagues start every month. Join anytime!</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-12 flex justify-center bg-primary">
        <div className="max-w-2xl w-full bg-white rounded-2xl shadow p-8 flex flex-col items-center border border-gold">
          <h2 className="text-2xl font-bold mb-2 text-primary">Scoring System</h2>
          <ul className="text-slate text-base mb-4">
          ...
          <p className="text-slate text-center text-sm">Points are calculated using ELO, game results, and move accuracy (ACL). See the rules for full details.</p>
        </div>
      </section>

      {/* Footer */}
      <footer className="w-full py-6 bg-primary text-gold text-center font-medium tracking-wide mt-auto border-t border-gold">
