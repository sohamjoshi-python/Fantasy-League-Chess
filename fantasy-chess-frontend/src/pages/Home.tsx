      ...
      <section className="w-full bg-white py-20 shadow-sm border-b border-gold">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/join-league" className="px-8 py-3 rounded-lg bg-gold text-white font-semibold text-lg shadow-lg hover:bg-purple hover:shadow-xl transition-all duration-200">Join a League</Link>
