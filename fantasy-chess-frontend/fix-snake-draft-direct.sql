-- Direct fix for snake draft order
-- Run this directly on the database to fix the marketplace order issue
...
-- Test the function with a sample league to verify it works
-- (This will be commented out to avoid affecting existing data)
-- SELECT start_marketplace('your-league-id-here'); 