-- Enhanced accept_trade function with player names in transaction descriptions
...
BEGIN
    ...
    -- Get player name separately
    SELECT name INTO player_name FROM chess_players WHERE id = trade_record.player_id;
    ...
    -- Create transaction records with player names
