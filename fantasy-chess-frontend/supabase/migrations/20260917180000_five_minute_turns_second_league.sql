-- TEMP: 5-minute snake-draft clock for these leagues:
...
BEGIN
        ...
        WHERE COALESCE(marketplace_started, false) = true
          ...
          AND COALESCE(
                ...
                created_at
                    ...
                    CASE
                        WHEN id = ANY (five_minute_league_ids) THEN interval '5 minutes'
    ...
    LOOP
        ...
        IF league_row.id = ANY (five_minute_league_ids) THEN
