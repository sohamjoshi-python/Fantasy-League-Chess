-- Ensure weekly scoring handles every bot, gives bots highest-Elo lineups,
-- and lets each bot buy one highest-Elo affordable player after the TT is scored.
...
BEGIN
    ...
    LOOP
        ...
        LOOP
            ...
            ON CONFLICT (bot_id, league_id) DO NOTHING;
