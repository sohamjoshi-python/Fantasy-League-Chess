-- Fix process_weekly_results crashing on bot coin balance insert.
-- Production league_coin_balances lacks UNIQUE(bot_id, league_id), so
-- ON CONFLICT (bot_id, league_id) raised 42P10 and rolled back all scoring.
