// Test SMTP email system directly
...
window.testSMTPDirectly = testSMTPDirectly;
window.testWelcomeEmailDirectly = testWelcomeEmailDirectly;

console.log('📋 Available test functions:');
console.log('- testSMTPDirectly() - Test custom email via SMTP');
console.log('- testWelcomeEmailDirectly() - Test welcome email via SMTP');
