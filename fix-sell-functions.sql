...
-- This updates the sell functions to work with the new coin system

-- Update sell_player_to_system function to work with league-specific coins
...
-- Update list_player_for_sale function to work with league-specific coins
